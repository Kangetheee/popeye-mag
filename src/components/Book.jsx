...
const Page = ({ number, front, back, page, opened, bookClosed, ...props }) => {
    ...
    useFrame((_, delta) => {
        ...
        // handles page rotation by checking if page is opened by checking roatation in both direction
        ...
        // bones[4].rotation.x = degToRad(20);

    });

    // handles cursor movement throughout the book
